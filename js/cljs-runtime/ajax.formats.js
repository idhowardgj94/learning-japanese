...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__58944){
var map__58945 = p__58944;
var map__58945__$1 = cljs.core.__destructure_map(map__58945);
var request = map__58945__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58945__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__58948 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__58948.cljs$core$IFn$_invoke$arity$1 ? fexpr__58948.cljs$core$IFn$_invoke$arity$1(response) : fexpr__58948.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__58949 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__58949.cljs$core$IFn$_invoke$arity$1 ? fexpr__58949.cljs$core$IFn$_invoke$arity$1(response) : fexpr__58949.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__58950){
var map__58951 = p__58950;
var map__58951__$1 = cljs.core.__destructure_map(map__58951);
var request = map__58951__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58951__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
