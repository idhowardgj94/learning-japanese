...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k43807,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__43840 = k43807;
var G__43840__$1 = (((G__43840 instanceof cljs.core.Keyword))?G__43840.fqn:null);
switch (G__43840__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k43807,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__43842){
var vec__43844 = p__43842;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43844,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43844,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__43806){
var self__ = this;
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43811,other43812){
var self__ = this;
var this43811__$1 = this;
return (((!((other43812 == null)))) && ((((this43811__$1.constructor === other43812.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43811__$1.tag,other43812.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43811__$1.prefix,other43812.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43811__$1.sym,other43812.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43811__$1.children,other43812.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43811__$1.__extmap,other43812.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k43807){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k43807);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__43806){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__43906 = cljs.core.keyword_identical_QMARK_;
var expr__43907 = k__5352__auto__;
if(cljs.core.truth_((pred__43906.cljs$core$IFn$_invoke$arity$2 ? pred__43906.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__43907) : pred__43906.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__43907)))){
return (new rewrite_clj.node.quote.QuoteNode(G__43806,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43906.cljs$core$IFn$_invoke$arity$2 ? pred__43906.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__43907) : pred__43906.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__43907)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__43806,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43906.cljs$core$IFn$_invoke$arity$2 ? pred__43906.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__43907) : pred__43906.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__43907)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__43806,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43906.cljs$core$IFn$_invoke$arity$2 ? pred__43906.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__43907) : pred__43906.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__43907)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__43806,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__43806),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__43806){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__43806,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__43821){
var extmap__5385__auto__ = (function (){var G__43935 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43821,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__43821)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43935);
} else {
return G__43935;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__43821),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__43821),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__43821),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__43821),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__43989 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__43989;
continue;
}
break;
...
var G__43990 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__43990;
continue;
}
break;
...
var G__43991 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__43991;
continue;
}
break;
...
var G__43992 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__43992;
continue;
}
break;
