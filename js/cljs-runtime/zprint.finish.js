...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__39116_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__39116_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__39116_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__39123){
var vec__39124 = p__39123;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39124,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39124,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__39135,s,color,element,idx){
var map__39136 = p__39135;
var map__39136__$1 = cljs.core.__destructure_map(map__39136);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39136__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39136__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39136__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__39141 = (function (){var or__5045__auto__ = color;
...
var fexpr__39140 = (function (){var G__39142 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__39142) : style_map.call(null,G__39142));
})();
return (fexpr__39140.cljs$core$IFn$_invoke$arity$1 ? fexpr__39140.cljs$core$IFn$_invoke$arity$1(G__39141) : fexpr__39140.call(null,G__39141));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__39151){
var vec__39153 = p__39151;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39153,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39153,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39153,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__39163){
var vec__39164 = p__39163;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39164,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39164,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39164,(2),null);
...
var G__39426 = cljs.core.next(ssv);
var G__39427 = (this_ssv == null);
var G__39428 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__39429 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__39426;
doing_nil_QMARK_ = G__39427;
last_elide = G__39428;
out = G__39429;
continue;
}
...
var vec__39194 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39194,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39194,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39194,(2),null);
...
var G__39440 = cljs.core.next(remaining_cvec);
var G__39441 = new_idx;
var G__39442 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__39440;
idx = G__39441;
out = G__39442;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__39221,cursor_vec){
var vec__39222 = p__39221;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39222,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39222,(1),null);
var focus_vec = vec__39222;
...
var vec__39225 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39225,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39225,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__39229){
var vec__39230 = p__39229;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39230,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39230,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__39241,existing_count){
var vec__39243 = p__39241;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39243,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39243,(1),null);
...
return cljs.core.filterv((function (p1__39234_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__39234_SHARP_))));
...
var vec__39264 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39264,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39264,(1),null);
var cvec_element = vec__39264;
if((cvec_element == null)){
var G__39494 = cljs.core.next(cvec_nl);
var G__39495 = (idx + (1));
var G__39496 = start;
var G__39497 = out;
cvec_nl = G__39494;
...
var G__39499 = cljs.core.next(cvec_nl);
var G__39500 = (idx + (1));
var G__39501 = idx;
var G__39502 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__39499;
idx = G__39500;
start = G__39501;
out = G__39502;
...
var G__39503 = cljs.core.next(cvec_nl);
var G__39504 = (idx + (1));
var G__39505 = (idx + (1));
var G__39506 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__39503;
idx = G__39504;
start = G__39505;
out = G__39506;
...
var G__39507 = cljs.core.next(cvec_nl);
var G__39508 = (idx + (1));
var G__39509 = idx;
var G__39510 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__39507;
idx = G__39508;
start = G__39509;
out = G__39510;
...
var G__39511 = cljs.core.next(cvec_nl);
var G__39512 = (idx + (1));
var G__39513 = start;
var G__39514 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__39511;
idx = G__39512;
start = G__39513;
out = G__39514;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__39307_SHARP_,p2__39306_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__39306_SHARP_)){
return cljs.core.reduced(p1__39307_SHARP_);
} else {
return (p1__39307_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__39319,p__39320){
var vec__39322 = p__39319;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39322,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39322,(1),null);
var vec__39325 = p__39320;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39325,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39325,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__39365,cvec,focus_vec){
var map__39366 = p__39365;
var map__39366__$1 = cljs.core.__destructure_map(map__39366);
var options = map__39366__$1;
var map__39367 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39366__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__39367__$1 = cljs.core.__destructure_map(map__39367);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39367__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39367__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39367__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39363_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__39363_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
