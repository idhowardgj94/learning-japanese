...
!0;const items=childrenArray.map((child,index,arr)=>{var _arr$,_arr$$props,_arr$2,_arr$2$props;if(!React.isValidElement(child))return null;(0,_reactIs.isFragment)(child)&&console.error("MUI: The Select component doesn't accept a Fragment as a child.\nConsider providing an array instead.");let selected;if(multiple){if(!Array.isArray(value))throw Error("MUI: The `value` prop must be an array when using the `Select` component with `multiple`.");(selected=value.some(v=>areEqualValues(v,child.props.value)))&&
computeDisplay&&displayMultiple.push(child.props.children)}else(selected=areEqualValues(value,child.props.value))&&computeDisplay&&(displaySingle=child.props.children);selected&&(foundMatch=!0);if(void 0===child.props.value)return React.cloneElement(child,{"aria-readonly":!0,role:"option"});index=()=>{if(value)return selected;const firstSelectableElement=arr.find(item=>{var _item$props;return void 0!==(null==item?void 0:null==(_item$props=item.props)?void 0:_item$props.value)&&!0!==item.props.disabled});
return child===firstSelectableElement?!0:selected};return React.cloneElement(child,{"aria-selected":selected?"true":"false",onClick:handleItemClick(child),onKeyUp:event=>{" "===event.key&&event.preventDefault();if(child.props.onKeyUp)child.props.onKeyUp(event)},role:"option",selected:void 0===(null==(_arr$=arr[0])?void 0:null==(_arr$$props=_arr$.props)?void 0:_arr$$props.value)||!0===(null==(_arr$2=arr[0])?void 0:null==(_arr$2$props=_arr$2.props)?void 0:_arr$2$props.disabled)?index():selected,value:void 0,
...
MenuProps.PaperProps,{style:(0,_extends2.default)({minWidth:menuMinWidth},null!=MenuProps.PaperProps?MenuProps.PaperProps.style:null)}),children:items}))]})});require.propTypes={"aria-describedby":module.default.string,"aria-label":module.default.string,autoFocus:module.default.bool,autoWidth:module.default.bool,children:module.default.node,classes:module.default.object,className:module.default.string,defaultOpen:module.default.bool,defaultValue:module.default.any,disabled:module.default.bool,displayEmpty:module.default.bool,
...
module.default.string]),type:module.default.any,value:module.default.any,variant:module.default.oneOf(["standard","outlined","filled"])};exports.default=require}
