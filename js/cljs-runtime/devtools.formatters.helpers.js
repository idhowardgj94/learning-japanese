...
var G__29816 = devtools.prefs.pref(v);
v = G__29816;
continue;
} else {
return v;
...
}catch (e29745){var _e__28814__auto__ = e29745;
return false;
}})();
...
}catch (e29750){var _e__28814__auto__ = e29750;
return false;
}})();
...
}catch (e29755){var _e__28814__auto__ = e29755;
return false;
}}
}
});
...
var vec__29777 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29777,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29777,(1),null);
...
return cljs.core.some((function (p1__29788_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29788_SHARP_);
}),template);
});
