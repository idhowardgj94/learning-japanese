...
var G__40792 = o;
reagent.impl.template.goog$module$goog$object.set(G__40792,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__40876__delegate = function (args){
...
return G__40876__delegate.call(this,args);};
...
return G__40876__delegate(args);
});
...
var G__40795 = o;
reagent.impl.template.goog$module$goog$object.set(G__40795,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__40881__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__40882__i < G__40882__a.length) {G__40882__a[G__40882__i] = arguments[G__40882__i + 0]; ++G__40882__i;}
  args = new cljs.core.IndexedSeq(G__40882__a,0,null);
} 
return G__40881__delegate.call(this,args);};
...
return G__40881__delegate(args);
});
...
var G__40796 = props;
var G__40796__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40796,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40796);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40796__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__40797 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40797,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__40797;
}
})(),id_class);
...
var G__40798 = (cljs.core.count(argv) - first_child);
switch (G__40798) {
case (0):
...
var vec__40806 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40806,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40806,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40806,(2),null);
...
var temp__5757__auto___40890 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___40890 == null)){
} else {
var key_40891 = temp__5757__auto___40890;
(jsprops.key = key_40891);
}
...
var temp__5757__auto___40892 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___40892 == null)){
} else {
var key_40893 = temp__5757__auto___40892;
...
var temp__5757__auto___40894 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___40894 == null)){
} else {
var key_40895 = temp__5757__auto___40894;
(jsprops.key = key_40895);
}
...
var temp__5757__auto___40896 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___40896 == null)){
} else {
var key_40897 = temp__5757__auto___40896;
(jsprops.key = key_40897);
}
...
var temp__5757__auto___40898 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___40898 == null)){
} else {
var key_40899 = temp__5757__auto___40898;
(jsprops.key = key_40899);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40825_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__40825_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__40829 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40829,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40829,(1),null);
...
break;
default:
var G__40901 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__40902 = compiler;
v = G__40901;
compiler = G__40902;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template40855 = (function (opts,id,fn_to_element,parse_fn,meta40857){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta40857 = meta40857;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template40855.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40858,meta40857__$1){
var self__ = this;
var _40858__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template40855(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta40857__$1));
}));

(reagent.impl.template.t_reagent$impl$template40855.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40858){
var self__ = this;
var _40858__$1 = this;
return self__.meta40857;
}));

(reagent.impl.template.t_reagent$impl$template40855.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template40855.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template40855.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template40855.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template40855.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template40855.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta40857","meta40857",-308351626,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template40855.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template40855.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template40855");

(reagent.impl.template.t_reagent$impl$template40855.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template40855");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template40855.
 */
reagent.impl.template.__GT_t_reagent$impl$template40855 = (function reagent$impl$template$__GT_t_reagent$impl$template40855(opts,id,fn_to_element,parse_fn,meta40857){
return (new reagent.impl.template.t_reagent$impl$template40855(opts,id,fn_to_element,parse_fn,meta40857));
});
...
return (new reagent.impl.template.t_reagent$impl$template40855(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
