...
var vec__52426 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__52433 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52433,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52433,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52426,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52426,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__52452){
var vec__52453 = p__52452;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52453,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52453,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52457,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52457,(1),null);
...
var vec__52479 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52479,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52479,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52479,(2),null);
var vec__52482 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52482,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52482,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52482,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__52504){
var vec__52505 = p__52504;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52505,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52505,(1),null);
...
var vec__52514 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52514,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52514,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52514,(2),null);
...
var vec__52566 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52566,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52566,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52566,(2),null);
var tuple = vec__52566;
...
var G__52907 = cljs.core.next(style_vec);
var G__52908 = ends_w_blanks_QMARK_;
var G__52909 = tuple;
var G__52910 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__52907;
previous_ends_w_blanks_QMARK_ = G__52908;
previous_tuple = G__52909;
out = G__52910;
continue;
}
break;
...
args__5775__auto__.push((arguments[i__5770__auto___52912]));
...
var vec__52601 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52601,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52601,(1),null);
...
var result = (function (){var G__52609 = zprint.core.parse_string_all_options(rest_options);
var G__52610 = zprint.core.zprint_str_internal;
var G__52611 = ":parse-string-all? call";
var G__52612 = (function (){var G__52620 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52620) : zprint.zutil.edn_STAR_.call(null,G__52620));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__52609,G__52610,G__52611,G__52612) : zprint.core.process_multiple_forms.call(null,G__52609,G__52610,G__52611,G__52612));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__52623 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52623,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52623,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq52581){
var G__52584 = cljs.core.first(seq52581);
var seq52581__$1 = cljs.core.next(seq52581);
var G__52585 = cljs.core.first(seq52581__$1);
var seq52581__$2 = cljs.core.next(seq52581__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52584,G__52585,seq52581__$2);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___52938 = arguments.length;
var i__5770__auto___52939 = (0);
while(true){
if((i__5770__auto___52939 < len__5769__auto___52938)){
args__5775__auto__.push((arguments[i__5770__auto___52939]));

var G__52941 = (i__5770__auto___52939 + (1));
i__5770__auto___52939 = G__52941;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq52643){
...
var args__5775__auto__ = [];
var len__5769__auto___52958 = arguments.length;
var i__5770__auto___52959 = (0);
while(true){
if((i__5770__auto___52959 < len__5769__auto___52958)){
args__5775__auto__.push((arguments[i__5770__auto___52959]));

var G__52960 = (i__5770__auto___52959 + (1));
i__5770__auto___52959 = G__52960;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq52655){
...
var args__5775__auto__ = [];
var len__5769__auto___52983 = arguments.length;
var i__5770__auto___52984 = (0);
while(true){
if((i__5770__auto___52984 < len__5769__auto___52983)){
args__5775__auto__.push((arguments[i__5770__auto___52984]));

var G__52990 = (i__5770__auto___52984 + (1));
i__5770__auto___52984 = G__52990;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq52663){
var G__52664 = cljs.core.first(seq52663);
var seq52663__$1 = cljs.core.next(seq52663);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52664,seq52663__$1);
}));
...
var G__52994 = (i__5770__auto___52992 + (1));
i__5770__auto___52992 = G__52994;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq52671){
var G__52672 = cljs.core.first(seq52671);
var seq52671__$1 = cljs.core.next(seq52671);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52672,seq52671__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__52692,form){
var vec__52693 = p__52692;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52693,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52693,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52693,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52693,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__52697 = (cljs.core.truth_((function (){var and__5043__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52697,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52697,(1),null);
...
var G__53020 = cljs.core.next(sos);
var G__53021 = comment_QMARK_;
var G__53022 = (function (){var or__5045__auto__ = (!(empty_string_QMARK_));
if(or__5045__auto__){
return or__5045__auto__;
} else {
...
var G__53023 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__53020;
previous_comment_QMARK_ = G__53021;
start_interpolating_QMARK_ = G__53022;
out = G__53023;
continue;
}
break;
...
try{var vec__52732 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52732,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52732,(1),null);
...
var vec__52735 = (cljs.core.truth_((function (){var or__5045__auto__ = range_start__$1;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52735,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52735,(1),null);
...
var vec__52738 = (cljs.core.truth_((function (){var and__5043__auto__ = actual_start;
if(cljs.core.truth_(and__5043__auto__)){
return actual_end;
} else {
return and__5043__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52738,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52738,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52738,(2),null);
...
var forms = (function (){var G__52757 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52757) : zprint.zutil.edn_STAR_.call(null,G__52757));
})();
