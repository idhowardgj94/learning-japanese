...
var vec__47550 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__47559 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47559,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47559,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47550,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47550,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__47596){
var vec__47599 = p__47596;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47599,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47599,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47606,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47606,(1),null);
...
var vec__47626 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47626,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47626,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47626,(2),null);
var vec__47629 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47629,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47629,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47629,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__47646){
var vec__47647 = p__47646;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47647,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47647,(1),null);
...
var vec__47653 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47653,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47653,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47653,(2),null);
...
var vec__47681 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47681,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47681,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47681,(2),null);
var tuple = vec__47681;
...
var G__48009 = cljs.core.next(style_vec);
var G__48010 = ends_w_blanks_QMARK_;
var G__48011 = tuple;
var G__48012 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__48009;
previous_ends_w_blanks_QMARK_ = G__48010;
previous_tuple = G__48011;
out = G__48012;
continue;
}
break;
...
var vec__47699 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47699,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47699,(1),null);
...
var result = (function (){var G__47706 = zprint.core.parse_string_all_options(rest_options);
var G__47707 = zprint.core.zprint_str_internal;
var G__47708 = ":parse-string-all? call";
var G__47709 = (function (){var G__47710 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__47710) : zprint.zutil.edn_STAR_.call(null,G__47710));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__47706,G__47707,G__47708,G__47709) : zprint.core.process_multiple_forms.call(null,G__47706,G__47707,G__47708,G__47709));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__47713 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47713,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47713,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq47688){
...
var args__5775__auto__ = [];
var len__5769__auto___48040 = arguments.length;
var i__5770__auto___48041 = (0);
while(true){
if((i__5770__auto___48041 < len__5769__auto___48040)){
args__5775__auto__.push((arguments[i__5770__auto___48041]));

var G__48044 = (i__5770__auto___48041 + (1));
i__5770__auto___48041 = G__48044;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq47737){
var G__47738 = cljs.core.first(seq47737);
var seq47737__$1 = cljs.core.next(seq47737);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47738,seq47737__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq47748){
var G__47749 = cljs.core.first(seq47748);
var seq47748__$1 = cljs.core.next(seq47748);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47749,seq47748__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___48063 = arguments.length;
var i__5770__auto___48064 = (0);
while(true){
if((i__5770__auto___48064 < len__5769__auto___48063)){
args__5775__auto__.push((arguments[i__5770__auto___48064]));

var G__48065 = (i__5770__auto___48064 + (1));
i__5770__auto___48064 = G__48065;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq47756){
var G__47757 = cljs.core.first(seq47756);
var seq47756__$1 = cljs.core.next(seq47756);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47757,seq47756__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___48076 = arguments.length;
var i__5770__auto___48077 = (0);
while(true){
if((i__5770__auto___48077 < len__5769__auto___48076)){
args__5775__auto__.push((arguments[i__5770__auto___48077]));

var G__48079 = (i__5770__auto___48077 + (1));
i__5770__auto___48077 = G__48079;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq47763){
var G__47764 = cljs.core.first(seq47763);
var seq47763__$1 = cljs.core.next(seq47763);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47764,seq47763__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__47786,form){
var vec__47788 = p__47786;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47788,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47788,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47788,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47788,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__47793 = (cljs.core.truth_((function (){var and__5043__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47793,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47793,(1),null);
...
var G__48116 = cljs.core.next(sos);
var G__48117 = comment_QMARK_;
var G__48118 = (function (){var or__5045__auto__ = (!(empty_string_QMARK_));
if(or__5045__auto__){
return or__5045__auto__;
} else {
...
var G__48119 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__48116;
previous_comment_QMARK_ = G__48117;
start_interpolating_QMARK_ = G__48118;
out = G__48119;
continue;
}
break;
...
try{var vec__47854 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47854,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47854,(1),null);
...
var vec__47857 = (cljs.core.truth_((function (){var or__5045__auto__ = range_start__$1;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47857,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47857,(1),null);
...
var vec__47860 = (cljs.core.truth_((function (){var and__5043__auto__ = actual_start;
if(cljs.core.truth_(and__5043__auto__)){
return actual_end;
} else {
return and__5043__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47860,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47860,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47860,(2),null);
...
var forms = (function (){var G__47880 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__47880) : zprint.zutil.edn_STAR_.call(null,G__47880));
})();
