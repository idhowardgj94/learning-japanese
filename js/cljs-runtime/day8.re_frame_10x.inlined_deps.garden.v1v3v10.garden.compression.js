 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__34103){
var vec__34104 = p__34103;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34104,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34104,(1),null);
return (function (s){
...
var len__5769__auto___34144 = arguments.length;
var i__5770__auto___34145 = (0);
while(true){
if((i__5770__auto___34145 < len__5769__auto___34144)){
args__5775__auto__.push((arguments[i__5770__auto___34145]));

var G__34146 = (i__5770__auto___34145 + (1));
i__5770__auto___34145 = G__34146;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__34113_SHARP_){
return (p1__34113_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__34113_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__34113_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq34115){
...
var map__34123 = temp__5751__auto__;
var map__34123__$1 = cljs.core.__destructure_map(map__34123);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34123__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34123__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34123__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__34153 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__34154 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__34139 = tag;
