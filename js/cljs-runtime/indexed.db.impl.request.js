...
(indexed.db.impl.request.Request.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"indexed.db.impl.request/Request");
}));
...
return cljs.core.native_satisfies_QMARK_(indexed.db.impl.protocols.IDBRequest,x);
} else {
return false;
}
}
...
return indexed.db.impl.protocols.result(db_request);
});
indexed.db.impl.request.ready_state = (function indexed$db$impl$request$ready_state(db_request){
return indexed.db.impl.protocols.ready_state(db_request);
});

//# sourceMappingURL=indexed.db.impl.request.js.map
