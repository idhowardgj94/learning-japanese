...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__38373_SHARP_){
return reitit.frontend.query_param(q,p1__38373_SHARP_);
})),q.getKeys()));
});
/**
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__38387){
var map__38388 = p__38387;
var map__38388__$1 = cljs.core.__destructure_map(map__38388);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38388__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
...
}catch (e38390){if((e38390 instanceof Error)){
var e = e38390;
...
if(cljs.core.every_QMARK_((function (p1__38399_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__38399_SHARP_);
