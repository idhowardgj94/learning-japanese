...
var o29791 = temp__5751__auto__;
var temp__5751__auto____$1 = (o29791["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o29792 = temp__5751__auto____$1;
return (o29792["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29011__auto__ = f;
return (o__29011__auto__["toString"]).call(o__29011__auto__);
} else {
return "";
}
}catch (e29793){var _ = e29793;
return "";
}});
...
try{var o__29011__auto___30138 = t;
(o__29011__auto___30138["cljs$lang$ctorPrWriter"]).call(o__29011__auto___30138,t,writer);
}catch (e29797){var __30139 = e29797;
}
...
var char_code = (function (){var o__29011__auto__ = (new String(char$));
return (o__29011__auto__["charCodeAt"]).call(o__29011__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29011__auto__ = String;
return (o__29011__auto__["fromCharCode"]).call(o__29011__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29828 = num_code;
switch (G__29828) {
case (1):
return (185);
...
var o__29011__auto__ = String;
return (o__29011__auto__["fromCharCode"]).call(o__29011__auto__,superscript_code);
});
/**
...
}catch (e29846){var _e__29032__auto__ = e29846;
return false;
}})())){
...
var vec__29847 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29847,(0),null);
...
var G__30162 = (i__5770__auto___30160 + (1));
i__5770__auto___30160 = G__30162;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29869){
var vec__29871 = p__29869;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29871,(0),null);
...
var G__30168 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30169 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30168;
remaining_tokens = G__30169;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29860){
var G__29861 = cljs.core.first(seq29860);
var seq29860__$1 = cljs.core.next(seq29860);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29861,seq29860__$1);
}));
...
var vec__29901 = cljs.core.split_with((function (p1__29883_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29883_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29901,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29901,(1),null);
...
var vec__29913 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29913,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29913,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30198 = cljs.core.rest(remaining_tokens);
var G__30199 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30198;
name_tokens = G__30199;
continue;
} else {
...
var vec__29918 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29918,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29918,(1),null);
var vec__29921 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29921,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29921,(1),null);
var vec__29924 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29924,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29924,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29924,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29924,(3),null);
...
var vec__29936 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29936,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29936,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29936,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29936,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29936,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29936,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__29945 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29945,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29945,(1),null);
var vec__29948 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29948,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29948,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29959 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29959) : devtools.munging.parse_fn_info_deep.call(null,G__29959));
})()));
}
} else {
return fn_info;
...
var G__30261 = (arity + (1));
var G__30262 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29990){
var vec__29993 = p__29990;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29993,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29993,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30009_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30009_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30010_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30010_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___30268 = arguments.length;
var i__5770__auto___30269 = (0);
while(true){
if((i__5770__auto___30269 < len__5769__auto___30268)){
args__5775__auto__.push((arguments[i__5770__auto___30269]));

var G__30270 = (i__5770__auto___30269 + (1));
i__5770__auto___30269 = G__30270;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30021){
var vec__30022 = p__30021;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30022,(0),null);
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30016,seq30015__$1);
}));
...
var G__30029 = arg;
var G__30029__$1 = (((G__30029 instanceof cljs.core.Keyword))?G__30029.fqn:null);
switch (G__30029__$1) {
...
var map__30056 = options;
var map__30056__$1 = cljs.core.__destructure_map(map__30056);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30056__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30056__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30056__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30056__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30057 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30057,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30057,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30057,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30057,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30057,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30057,(5),null);
...
var o__29011__auto__ = f;
return (o__29011__auto__["getBasis"]).call(o__29011__auto__);
});
/**
...
}catch (e30075){var _e__29032__auto__ = e30075;
...
var G__30290 = (obj[cljs.core.first(path)]);
var G__30291 = cljs.core.rest(path);
obj = G__30290;
path = G__30291;
continue;
} else {
...
var _STAR_ = (function (accum,p__30101){
var vec__30102 = p__30101;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30102,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30102,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30110){
var vec__30112 = p__30110;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30112,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30112,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30112,(2),null);
...
var post_process = (function (p__30122){
var vec__30123 = p__30122;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30123,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30123,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30121_SHARP_){
return (obj[cljs.core.first(p1__30121_SHARP_)]);
}),sorted_matches);
