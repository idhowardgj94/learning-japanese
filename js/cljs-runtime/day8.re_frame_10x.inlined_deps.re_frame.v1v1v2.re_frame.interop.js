...
return [(function (){var pred__31656 = cljs.core.instance_QMARK_;
var expr__31657 = reactive_val;
if(cljs.core.truth_((pred__31656.cljs$core$IFn$_invoke$arity$2 ? pred__31656.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__31657) : pred__31656.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__31657)))){
return "ra";
} else {
if(cljs.core.truth_((pred__31656.cljs$core$IFn$_invoke$arity$2 ? pred__31656.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__31657) : pred__31656.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__31657)))){
return "rc";
} else {
if(cljs.core.truth_((pred__31656.cljs$core$IFn$_invoke$arity$2 ? pred__31656.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__31657) : pred__31656.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__31657)))){
return "rx";
} else {
if(cljs.core.truth_((pred__31656.cljs$core$IFn$_invoke$arity$2 ? pred__31656.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__31657) : pred__31656.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__31657)))){
return "tr";
} else {
return "other";
}
