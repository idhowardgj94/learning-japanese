...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_51540 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_51540(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_51541 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_51541(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_51542 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_51542(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_51543 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_51543(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_51545 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_51545(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_51546 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_51546(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_51548 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_51548(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_51551 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_51551(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_51557 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_51557(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_51563 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_51563(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k51467,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k51467,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__51489){
var vec__51491 = p__51489;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51491,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51491,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__51466){
var self__ = this;
var G__51466__$1 = this;
return (new cljs.core.RecordIter((0),G__51466__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this51468,other51469){
var self__ = this;
var this51468__$1 = this;
return (((!((other51469 == null)))) && ((((this51468__$1.constructor === other51469.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51468__$1.status,other51469.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51468__$1.body,other51469.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51468__$1.status_text,other51469.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51468__$1.headers,other51469.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51468__$1.was_aborted,other51469.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51468__$1.__extmap,other51469.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k51467){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k51467);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__51466){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__51524 = cljs.core.keyword_identical_QMARK_;
var expr__51525 = k__5352__auto__;
if(cljs.core.truth_((pred__51524.cljs$core$IFn$_invoke$arity$2 ? pred__51524.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__51525) : pred__51524.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__51525)))){
return (new ajax.protocols.Response(G__51466,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51524.cljs$core$IFn$_invoke$arity$2 ? pred__51524.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__51525) : pred__51524.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__51525)))){
return (new ajax.protocols.Response(self__.status,G__51466,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51524.cljs$core$IFn$_invoke$arity$2 ? pred__51524.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__51525) : pred__51524.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__51525)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__51466,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51524.cljs$core$IFn$_invoke$arity$2 ? pred__51524.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__51525) : pred__51524.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__51525)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__51466,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51524.cljs$core$IFn$_invoke$arity$2 ? pred__51524.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__51525) : pred__51524.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__51525)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__51466,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__51466),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__51466){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__51466,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__51478){
var extmap__5385__auto__ = (function (){var G__51536 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__51478,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__51478)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__51536);
} else {
return G__51536;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__51478),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__51478),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__51478),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__51478),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__51478),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
