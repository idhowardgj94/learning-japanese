...
return [(function (){var pred__36972 = cljs.core.instance_QMARK_;
var expr__36973 = reactive_val;
if(cljs.core.truth_((pred__36972.cljs$core$IFn$_invoke$arity$2 ? pred__36972.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__36973) : pred__36972.call(null,reagent.ratom.RAtom,expr__36973)))){
return "ra";
} else {
if(cljs.core.truth_((pred__36972.cljs$core$IFn$_invoke$arity$2 ? pred__36972.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__36973) : pred__36972.call(null,reagent.ratom.RCursor,expr__36973)))){
return "rc";
} else {
if(cljs.core.truth_((pred__36972.cljs$core$IFn$_invoke$arity$2 ? pred__36972.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__36973) : pred__36972.call(null,reagent.ratom.Reaction,expr__36973)))){
return "rx";
} else {
if(cljs.core.truth_((pred__36972.cljs$core$IFn$_invoke$arity$2 ? pred__36972.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__36973) : pred__36972.call(null,reagent.ratom.Track,expr__36973)))){
return "tr";
} else {
return "other";
}
