...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k43884,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k43884,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__43911){
var vec__43912 = p__43911;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43912,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43912,(1),null);
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__43883){
var self__ = this;
var G__43883__$1 = this;
return (new cljs.core.RecordIter((0),G__43883__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"lines","lines",-700165781)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43885,other43886){
var self__ = this;
var this43885__$1 = this;
return (((!((other43886 == null)))) && ((((this43885__$1.constructor === other43886.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43885__$1.lines,other43886.lines)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43885__$1.__extmap,other43886.__extmap)))))));
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k43884){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k43884);

}
}));

(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__43883){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__43958 = cljs.core.keyword_identical_QMARK_;
var expr__43959 = k__5352__auto__;
if(cljs.core.truth_((pred__43958.cljs$core$IFn$_invoke$arity$2 ? pred__43958.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"lines","lines",-700165781),expr__43959) : pred__43958.call(null,new cljs.core.Keyword(null,"lines","lines",-700165781),expr__43959)))){
return (new rewrite_clj.node.stringz.StringNode(G__43883,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.stringz.StringNode(self__.lines,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__43883),null));
}
}));
...
(rewrite_clj.node.stringz.StringNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__43883){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.stringz.StringNode(self__.lines,G__43883,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.stringz.map__GT_StringNode = (function rewrite_clj$node$stringz$map__GT_StringNode(G__43889){
var extmap__5385__auto__ = (function (){var G__43970 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__43889,new cljs.core.Keyword(null,"lines","lines",-700165781));
if(cljs.core.record_QMARK_(G__43889)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43970);
} else {
return G__43970;
}
})();
return (new rewrite_clj.node.stringz.StringNode(new cljs.core.Keyword(null,"lines","lines",-700165781).cljs$core$IFn$_invoke$arity$1(G__43889),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
