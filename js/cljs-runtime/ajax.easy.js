...
var G__58977 = format;
var G__58977__$1 = (((G__58977 instanceof cljs.core.Keyword))?G__58977.fqn:null);
switch (G__58977__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__58978 = cljs.core.second(format);
var G__58979 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__58978,G__58979) : ajax.easy.keyword_response_format_element.call(null,G__58978,G__58979));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58981_SHARP_){
return ajax.easy.keyword_response_format_element(p1__58981_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__58982){
var map__58983 = p__58982;
var map__58983__$1 = cljs.core.__destructure_map(map__58983);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58983__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58983__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58983__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__58984){
var vec__58985 = p__58984;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58985,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58985,(1),null);
var fexpr__58988_58994 = (cljs.core.truth_(ok)?h:e);
(fexpr__58988_58994.cljs$core$IFn$_invoke$arity$1 ? fexpr__58988_58994.cljs$core$IFn$_invoke$arity$1(result) : fexpr__58988_58994.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__58989){
var map__58990 = p__58989;
var map__58990__$1 = cljs.core.__destructure_map(map__58990);
var opts = map__58990__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58990__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58990__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58990__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58990__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58990__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
