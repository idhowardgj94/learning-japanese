...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29823){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29824,G__29825,seq29823__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29880_SHARP_){
return (!((cljs.core.meta(p1__29880_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29891__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29893){var _e__28814__auto__ = e29893;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e29898){var _e__28814__auto__ = e29898;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29901 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29902 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29902);

try{devtools.formatters.state.add_object_to_current_path_info_BANG_(obj);

var map__29903 = opts;
var map__29903__$1 = cljs.core.__destructure_map(map__29903);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29903__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29901);
}});
...
var temp__5751__auto___29974 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___29974)){
var managed_print_level_29975 = temp__5751__auto___29974;
var _STAR_print_level_STAR__orig_val__29906_29976 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29907_29977 = managed_print_level_29975;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29907_29977);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29904_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29904_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29906_29976);
}} else {
job_fn();
}
