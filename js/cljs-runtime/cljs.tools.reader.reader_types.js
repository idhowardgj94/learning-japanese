...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_34889 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_34889(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_34895 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_34895(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_34901 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_34901(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_34905 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_34905(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_34908 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_34908(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_34912 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_34912(reader);
}
});
...
var G__34972 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__34973 = s.append(c);
c = G__34972;
s = G__34973;
continue;
}
