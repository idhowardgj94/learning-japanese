...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44269 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44269(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_44288 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_44288(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_44289 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_44289(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_44290 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_44290(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44294 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44294(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44295 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44295(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__44258,callback){
var map__44259 = p__44258;
var map__44259__$1 = cljs.core.__destructure_map(map__44259);
var input = map__44259__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44259__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44259__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
