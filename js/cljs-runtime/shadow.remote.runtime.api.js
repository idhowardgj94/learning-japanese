...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45415 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45415(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_45416 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_45416(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_45418 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_45418(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_45420 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_45420(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45421 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45421(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45422 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45422(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__45407,callback){
var map__45408 = p__45407;
var map__45408__$1 = cljs.core.__destructure_map(map__45408);
var input = map__45408__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45408__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45408__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
