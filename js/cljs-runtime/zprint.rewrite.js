...
var G__41584 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__41584;
continue;
} else {
var G__41585 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__41585;
continue;
}
} else {
var G__41586 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__41586;
continue;
}
}
...
var G__41511 = zloc;
var G__41512 = (function (){var G__41513 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__41514 = zloc;
var G__41514__$1 = (((G__41514 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__41514) : rewrite_clj.zip.node.call(null,G__41514)));
if((G__41514__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__41514__$1) : zprint.zutil.edn_STAR_.call(null,G__41514__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__41513) : rewrite_clj.zip.root.call(null,G__41513));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__41511,G__41512) : rewrite_clj.zip.replace.call(null,G__41511,G__41512));
});
/**
...
var G__41594 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__41594;
continue;
}
break;
...
var G__41601 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__41602 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__41601;
out = G__41602;
continue;
} else {
...
var G__41609 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__41610 = cljs.core.next(new_loc);
var G__41611 = replaced_loc;
nloc = G__41609;
new_loc = G__41610;
last_loc = G__41611;
continue;
...
return zprint.rewrite.sort_val((function (){var G__41561 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__41561) : rewrite_clj.zip.down.call(null,G__41561));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__41564_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__41564_SHARP_) : rewrite_clj.zip.tag.call(null,p1__41564_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__41564_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__41564_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
