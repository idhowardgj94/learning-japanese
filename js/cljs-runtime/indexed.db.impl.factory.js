...
var self__ = this;
var ___$1 = this;
return indexed.db.impl.request.create_request(self__.factory.open(name,version));
}));

(indexed.db.impl.factory.Factory.prototype.indexed$db$impl$protocols$IDBFactory$delete_database$arity$2 = (function (_,name){
var self__ = this;
var ___$1 = this;
return indexed.db.impl.request.create_request(self__.factory.deleteDatabase(name));
}));
...
var self__ = this;
var ___$1 = this;
if(cljs.core.truth_(cljs.core.type(self__.factory.databases))){
var p = self__.factory.databases();
return p.then((function (result){
var G__45099 = result;
var G__45099__$1 = ((cljs.core.array_QMARK_(result))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(indexed.db.impl.factory.dict__GT_map,cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(G__45099)):G__45099);
return (fn_1.cljs$core$IFn$_invoke$arity$1 ? fn_1.cljs$core$IFn$_invoke$arity$1(G__45099__$1) : fn_1.call(null,G__45099__$1));

}));
} else {
var G__45103 = cljs.core.List.EMPTY;
return (fn_1.cljs$core$IFn$_invoke$arity$1 ? fn_1.cljs$core$IFn$_invoke$arity$1(G__45103) : fn_1.call(null,G__45103));
}
}));
...
(indexed.db.impl.factory.Factory.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"indexed.db.impl.factory/Factory");
}));
...
cljs.core.type(indexedDB.databases);
...
return cljs.core.native_satisfies_QMARK_(indexed.db.impl.protocols.IDBFactory,x);
} else {
return false;
}
}
...
return indexed.db.impl.protocols.open(factory,name,version);
}));

(indexed.db.impl.factory.open.cljs$core$IFn$_invoke$arity$2 = (function (name,version){
return indexed.db.impl.factory.open.cljs$core$IFn$_invoke$arity$3(indexed.db.impl.factory.create_factory(),name,version);
}));

(indexed.db.impl.factory.open.cljs$core$IFn$_invoke$arity$1 = (function (name){
return indexed.db.impl.factory.open.cljs$core$IFn$_invoke$arity$2(indexed.db.impl.factory.create_factory(),name);
}));
...
return indexed.db.impl.protocols.delete_database(factory,name);
}));

(indexed.db.impl.factory.delete_database.cljs$core$IFn$_invoke$arity$1 = (function (name){
return indexed.db.impl.factory.delete_database.cljs$core$IFn$_invoke$arity$2(indexed.db.impl.factory.create_factory(),name);
}));
...
return indexed.db.impl.protocols.cmp(factory,a,b);
}));

(indexed.db.impl.factory.cmp.cljs$core$IFn$_invoke$arity$2 = (function (a,b){
return indexed.db.impl.factory.cmp.cljs$core$IFn$_invoke$arity$3(indexed.db.impl.factory.create_factory(),a,b);
}));
...
indexed.db.impl.protocols.databases(factory,fn_1);

return factory;
}));

(indexed.db.impl.factory.databases.cljs$core$IFn$_invoke$arity$1 = (function (fn_1){
return indexed.db.impl.factory.databases.cljs$core$IFn$_invoke$arity$2(indexed.db.impl.factory.create_factory(),fn_1);
}));

(indexed.db.impl.factory.databases.cljs$lang$maxFixedArity = 2);


//# sourceMappingURL=indexed.db.impl.factory.js.map
