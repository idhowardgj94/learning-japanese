...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k39589,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k39589,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__39616){
var vec__39617 = p__39616;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39617,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39617,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__39588){
var self__ = this;
var G__39588__$1 = this;
return (new cljs.core.RecordIter((0),G__39588__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this39590,other39591){
var self__ = this;
var this39590__$1 = this;
return (((!((other39591 == null)))) && ((((this39590__$1.constructor === other39591.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this39590__$1.tag,other39591.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this39590__$1.wrap_fn,other39591.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this39590__$1.wrap_length,other39591.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this39590__$1.seq_fn,other39591.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this39590__$1.children,other39591.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this39590__$1.__extmap,other39591.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__39647 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__39647) : self__.seq_fn.call(null,G__39647));
}));
...
var self__ = this;
var this$__$1 = this;
var G__39650 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__39650) : self__.wrap_fn.call(null,G__39650));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k39589){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k39589);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__39588){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__39663 = cljs.core.keyword_identical_QMARK_;
var expr__39664 = k__5352__auto__;
if(cljs.core.truth_((pred__39663.cljs$core$IFn$_invoke$arity$2 ? pred__39663.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__39664) : pred__39663.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__39664)))){
return (new rewrite_clj.node.seq.SeqNode(G__39588,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__39663.cljs$core$IFn$_invoke$arity$2 ? pred__39663.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__39664) : pred__39663.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__39664)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__39588,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__39663.cljs$core$IFn$_invoke$arity$2 ? pred__39663.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__39664) : pred__39663.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__39664)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__39588,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__39663.cljs$core$IFn$_invoke$arity$2 ? pred__39663.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__39664) : pred__39663.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__39664)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__39588,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__39663.cljs$core$IFn$_invoke$arity$2 ? pred__39663.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__39664) : pred__39663.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__39664)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__39588,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__39588),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__39588){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__39588,self__.__extmap,self__.__hash));
}));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__39596),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__39596),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__39596),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__39596),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__39596),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__39688_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__39688_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__39690_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__39690_SHARP_);
}),children);
});
