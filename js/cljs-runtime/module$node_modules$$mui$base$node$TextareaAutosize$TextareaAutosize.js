...
global=global(require("module$node_modules$prop_types$index"));var _reactDom=require("module$node_modules$react_dom$index"),_utils=require("module$node_modules$$mui$utils$index"),_jsxRuntime=require("module$node_modules$react$jsx_runtime");const _excluded=["onChange","maxRows","minRows","style","value"];var JSCompiler_object_inline_shadow_952={visibility:"hidden",position:"absolute",overflow:"hidden",height:0,top:0,left:0,transform:"translateZ(0)"};require=React.forwardRef(function(props,ref){const {onChange,
