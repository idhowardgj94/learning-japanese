...
var G__40315 = (function (){var G__40316 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__40316) : f.call(null,G__40316));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__40315) : rewrite_clj.node.coerce.call(null,G__40315));
});
/**
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__40317_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__40317_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq40318){
var G__40319 = cljs.core.first(seq40318);
var seq40318__$1 = cljs.core.next(seq40318);
var G__40320 = cljs.core.first(seq40318__$1);
var seq40318__$2 = cljs.core.next(seq40318__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40319,G__40320,seq40318__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__40340 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__40340) : str_fn.call(null,G__40340));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__40344 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__40344) : str_fn.call(null,G__40344));
})()):null)));
...
var G__40354 = rewrite_clj.zip.base.tag(zloc);
var G__40354__$1 = (((G__40354 instanceof cljs.core.Keyword))?G__40354.fqn:null);
switch (G__40354__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__40352_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__40352_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__40353_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__40353_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40354__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__40365 = rewrite_clj.zip.base.tag(zloc);
var G__40365__$1 = (((G__40365 instanceof cljs.core.Keyword))?G__40365.fqn:null);
switch (G__40365__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__40364_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__40364_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40365__$1)].join('')));
