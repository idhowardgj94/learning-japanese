...
var vec__57802 = cljs.core.rest(expr);
...
var vec__57805 = first__57804;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57805,(0),null);
var form = seq__57803__$1;
...
var G__57810 = x;
var G__57810__$1 = (((G__57810 == null))?null:spec_tools.impl.polish(G__57810));
var G__57810__$2 = (((G__57810__$1 == null))?null:cljs.core.name(G__57810__$1));
if((G__57810__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__57810__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__57811 = x;
var G__57811__$1 = (((G__57811 == null))?null:cljs.core.name(G__57811));
if((G__57811__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__57811__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__57814){
var map__57815 = p__57814;
var map__57815__$1 = cljs.core.__destructure_map(map__57815);
var data = map__57815__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57815__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57815__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57815__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57815__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__57823){
var map__57824 = p__57823;
var map__57824__$1 = cljs.core.__destructure_map(map__57824);
var data = map__57824__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57824__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57824__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__57825 = data;
var G__57825__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57825,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__57825);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57825__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__57825__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__57835 = form;
var G__57835__$1 = (((G__57835 == null))?null:cljs.core.rest(G__57835));
if((G__57835__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__57835__$1);
}
})();
var G__57836 = m;
var G__57836__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57836,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__57829_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__57829_SHARP_)));
})):G__57836);
var G__57836__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57836__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__57830_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__57830_SHARP_)));
})):G__57836__$1);
var G__57836__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57836__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__57831_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__57831_SHARP_));
})):G__57836__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__57836__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__57841 = (function (){var G__57842 = form;
var G__57842__$1 = (((G__57842 == null))?null:cljs.core.rest(G__57842));
if((G__57842__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__57842__$1);
}
})();
var map__57841__$1 = cljs.core.__destructure_map(map__57841);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57841__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57841__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57841__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57841__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__57853 = (function (){var and__5043__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__57862 = form;
var G__57862__$1 = (((G__57862 == null))?null:cljs.core.seq(G__57862));
var G__57862__$2 = (((G__57862__$1 == null))?null:cljs.core.first(G__57862__$1));
if((G__57862__$2 == null)){
return null;
} else {
var fexpr__57863 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__57863.cljs$core$IFn$_invoke$arity$1 ? fexpr__57863.cljs$core$IFn$_invoke$arity$1(G__57862__$2) : fexpr__57863.call(null,G__57862__$2));
}
})():null));
});
/**
...
var len__5769__auto___57902 = arguments.length;
var i__5770__auto___57903 = (0);
while(true){
if((i__5770__auto___57903 < len__5769__auto___57902)){
args__5775__auto__.push((arguments[i__5770__auto___57903]));

var G__57904 = (i__5770__auto___57903 + (1));
i__5770__auto___57903 = G__57904;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq57866){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__57867){
var vec__57868 = p__57867;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57868,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57868,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__57874){
var map__57875 = p__57874;
var map__57875__$1 = cljs.core.__destructure_map(map__57875);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57875__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57875__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57875__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57875__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__57872_SHARP_){
return cljs.core.map_QMARK_(p1__57872_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__57873_SHARP_){
return cljs.core.contains_QMARK_(p1__57873_SHARP_,x);
});
}),req_keys));
