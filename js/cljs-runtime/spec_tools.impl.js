...
var vec__36110 = cljs.core.rest(expr);
...
var vec__36113 = first__36112;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36113,(0),null);
var form = seq__36111__$1;
...
var G__36116 = x;
var G__36116__$1 = (((G__36116 == null))?null:spec_tools.impl.polish(G__36116));
var G__36116__$2 = (((G__36116__$1 == null))?null:cljs.core.name(G__36116__$1));
if((G__36116__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__36116__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__36117 = x;
var G__36117__$1 = (((G__36117 == null))?null:cljs.core.name(G__36117));
if((G__36117__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__36117__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__36121){
var map__36122 = p__36121;
var map__36122__$1 = cljs.core.__destructure_map(map__36122);
var data = map__36122__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36122__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36122__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36122__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36122__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__36123){
var map__36127 = p__36123;
var map__36127__$1 = cljs.core.__destructure_map(map__36127);
var data = map__36127__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36127__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36127__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__36128 = data;
var G__36128__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__36128,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__36128);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__36128__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__36128__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__36137 = form;
var G__36137__$1 = (((G__36137 == null))?null:cljs.core.rest(G__36137));
if((G__36137__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__36137__$1);
}
})();
var G__36138 = m;
var G__36138__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__36138,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__36131_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__36131_SHARP_)));
})):G__36138);
var G__36138__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__36138__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__36132_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__36132_SHARP_)));
})):G__36138__$1);
var G__36138__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__36138__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__36133_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__36133_SHARP_));
})):G__36138__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__36138__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__36141 = (function (){var G__36142 = form;
var G__36142__$1 = (((G__36142 == null))?null:cljs.core.rest(G__36142));
if((G__36142__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__36142__$1);
}
})();
var map__36141__$1 = cljs.core.__destructure_map(map__36141);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36141__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36141__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36141__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36141__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__36146 = (function (){var and__5043__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__36150 = form;
var G__36150__$1 = (((G__36150 == null))?null:cljs.core.seq(G__36150));
var G__36150__$2 = (((G__36150__$1 == null))?null:cljs.core.first(G__36150__$1));
if((G__36150__$2 == null)){
return null;
} else {
var fexpr__36151 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__36151.cljs$core$IFn$_invoke$arity$1 ? fexpr__36151.cljs$core$IFn$_invoke$arity$1(G__36150__$2) : fexpr__36151.call(null,G__36150__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq36152){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36152));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__36153){
var vec__36154 = p__36153;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36154,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36154,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__36179){
var map__36180 = p__36179;
var map__36180__$1 = cljs.core.__destructure_map(map__36180);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36180__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36180__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36180__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36180__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__36177_SHARP_){
return cljs.core.map_QMARK_(p1__36177_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__36178_SHARP_){
return cljs.core.contains_QMARK_(p1__36178_SHARP_,x);
});
}),req_keys));
